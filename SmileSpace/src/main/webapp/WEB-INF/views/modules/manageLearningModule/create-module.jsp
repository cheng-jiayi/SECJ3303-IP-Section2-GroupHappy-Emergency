...
<body>
                ...
                <div class="form-layout">
                    ...
                    <div class="left-column">
                        ...
                        <div class="form-group">
                            ...
                            <div class="current-file" id="coverPreviewCurrent" style="display: none;">
    ...
    <script>
                    ...
                    if (isImage) {
                        ...
                        if (previewImg) {
                            ...
                            reader.onload = function(e) {
                                ...
                                if (currentFileDiv) {
                                    currentFileDiv.innerHTML = `<i class="fas fa-image"></i> Selected: ${fileName}`;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setupFileUpload('coverUpload', 'coverImageInput', 'coverUploadText', 'coverFileInfo', 'coverPreview', 'coverPreviewCurrent', true);
            
            // Resource file upload
            setupFileUpload('resourceUpload', 'resourceFileInput', 'resourceUploadText', 'resourceFileInfo', null, null, false);
        });
