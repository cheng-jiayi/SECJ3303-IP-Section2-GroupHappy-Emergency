...
<%
    ...
    // FIX: For edit mode, get date from moodToEdit if not in URL
    if (isEdit && moodToEdit != null && (dateParam == null || dateParam.isEmpty())) {
        dateParam = moodToEdit.getEntryDate().toString();
        System.out.println("DEBUG: Edit mode - using date from mood entry: " + dateParam);
    }
    
    // Debug logging
    System.out.println("=== DEBUG addMoodFeelings.jsp ===");
    System.out.println("Date parameter: " + dateParam);
    System.out.println("Edit mode: " + isEdit);
    System.out.println("Mood entry date: " + (moodToEdit != null ? moodToEdit.getEntryDate() : "null"));
    ...
    // If we have a date parameter, add it to the back URL
