...
<div class="container">
    <div class="header">
        ...
        <a href="referral?action=viewStudents" class="back-btn">
    ...
    <div class="main-content">
            ...
            <div class="student-details">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value">
                        <span class="risk-high"><%= student.getRiskLevel() %></span>
                    </div>
                </div>
                <div class="detail-row">
        ...
        <div class="card">
            ...
            <form action="referral" method="post" id="referralForm">
                <input type="hidden" name="action" value="submitReferral">
                ...
                <div class="form-actions">
                    <a href="referral?action=viewStudents" class="cancel-btn">
