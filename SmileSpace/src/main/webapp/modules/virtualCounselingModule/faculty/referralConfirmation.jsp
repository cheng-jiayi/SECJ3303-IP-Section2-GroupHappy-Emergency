...
<div class="container">
            ...
            <div class="student-details">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value">
                        <%= student.getProgram() %> / Year <%= student.getYear() %>
                    </div>
                </div>
                <div class="detail-row">
                    <div class="detail-label">Recent Mood</div>
                    <div class="detail-value"><%= student.getRecentMood() != null ? student.getRecentMood() : "No mood data" %></div>
                </div>
                <div class="detail-row">
    ...
    <div class="actions">
        <a href="referral?action=viewStudents" class="action-btn primary-btn">
