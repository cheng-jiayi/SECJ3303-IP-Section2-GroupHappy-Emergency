...
<%
    ...
    if (userRole == null || !"faculty".equals(userRole)) {
        response.sendRedirect("../loginPage.jsp");
        return;
    }
    
    // Faculty-specific data
    String staffNumber = "FAC001";
    
    // Set defaults
    if (phone == null) phone = "012-3456000";
    if (email == null) email = "faculty1@utm.my";
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container">
        <div class="header">
            <a href="../dashboards/facultyDashboard.jsp" class="back-btn">
        ...
        <div class="subtitle">Manage your faculty information and account settings</div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" id="staffNumber" value="<%= staffNumber %>" readonly>
    ...
    <!-- Password Change Modal (Same as student but different color) -->
    ...
    <script>
        // Same JavaScript as student profile
