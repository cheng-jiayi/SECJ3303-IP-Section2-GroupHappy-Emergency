...
<head>
    <meta charset="UTF-8">
    <title>Faculty Dashboard - SmileSpace</title>
...
<body>
    ...
    <div class="container">
        <div class="welcome">
            ...
            <p>Faculty Management Dashboard</p>
        </div>
        ...
        <div class="card-container">
            ...
            <div class="card" onclick="window.location.href='<%= request.getContextPath() %>/facultyreferral'">
                <div class="card-icon">
                    <i class="fas fa-user-graduate"></i>
                </div>
                <div class="card-title">Refer At-Risk Student</div>
                <div class="card-desc">Identify and refer students</div>
            </div>
            ...
            <div class="card" onclick="window.location.href='<%= request.getContextPath() %>/modules/peerSupportForumModule/forumHome.jsp'">
                ...
                <div class="card-title">Peer Support Forum</div>
