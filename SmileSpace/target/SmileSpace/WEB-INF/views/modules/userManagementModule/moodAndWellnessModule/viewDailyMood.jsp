...
<%
    ...
    // Debug logging
    System.out.println("=== DEBUG viewDailyMood ===");
        ...
        <div class="image-section">
            ...
            <div class="image-container">
                <% if (hasImage) { 
                    ...
                    fullImagePath = request.getContextPath() + "/" + cleanedPath;
                    
                    System.out.println("DEBUG: Cleaned path: " + cleanedPath);
                    System.out.println("DEBUG: Full image URL: " + fullImagePath);
                %>
        ...
        if (img) {
            img.onerror = function() {
                ...
                if (container) {
                    ...
                    errorMsg.innerHTML = '<i class="fas fa-exclamation-triangle"></i><div>Image not found</div>';
