...
<%
    ...
    // Admin-specific data
    String staffNumber = "ADM001";
    
    // Set defaults
    if (phone == null) phone = "012-3456787";
    if (email == null) email = "admin1@utm.my";
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="container">
        <div class="header">
            <a href="../dashboards/adminDashboard.jsp" class="back-btn">
        ...
        <div class="subtitle">Manage your administrator information and account settings</div>
